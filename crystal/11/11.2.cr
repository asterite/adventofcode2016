# Takes 3 minutes to complete and more than 8GB of memory
...
floors = input.each_line.with_index.map do |(line, index)|
  if index == 0
    line += " an elerium generator, an elerium-compatible microchip, a dilithim generator, a dilithim-compatible microchip"
  end
